import { GithubRepoMockData } from '../types';
...
export class MockGithubMcpService {
   ...
   */
  public static async inspectRepository(username: string = 'candidate', roleHint?: string): Promise<GithubRepoMockData> {
   ...
   */
  public static formatMcpContextForAgent(data: GithubRepoMockData): string {
    return `
